...
<body>
            ...
            <div class="wrapper">
                <div class="content-inner">
                    ...
                    <div class="menu-mobile">
                        <div class="logo-box">
                            <div class="img-box">
                                <img src="/img/logo.png" alt="bambini club">
                            </div>
                            <span>Федеральная сеть детских садиков Bambini-club</span>
                        </div>
                        ...
                        <div class="confident">
                            <a>
                                <span data-modalname="modal-privacy-policy">Политика конфиденциальности</span>
                            </a>
                        </div>
                        <div class="social-and-learn-more">
                            <a href="#" class="menu-mobile_social-link">
                                <img src="/img/vk_mobile.svg">
                            </a>
                            <a href="#"  class="menu-mobile_social-link">
                                <img src="/img/instagramm_mobile.svg">
                            </a>
                ...
                <div class="form">
                    <form>
                        ...
                        <div class="input-item-checkbox">
                            ...
                            <label for="tour_accept">Я принимаю условия <a data-modalname="modal-privacy-policy">Пользовательского соглашения</a></label>
                        </div>
    ...
    <div id="modal-privacy-policy" class="modal-window">
    	...
    	<div class="container">
    		<div class="content">
                ...
                <div class="inner">
                    ...
                    <p>Вступление в силу новой Политики конфиденциальности начинается после того, как информация о ней будет выложена на сайт, если изменившаяся Политика не подразумевает иного варианта размещения.</p>
                </div>
    		</div>
    	</div>
    </div>
